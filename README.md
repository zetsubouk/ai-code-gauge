...
- [x] 近 7 日用量趋势文字（日均 + 今日值；本地每日快照，滚动保留 30 天）
...
> 也可以在 [Releases](https://github.com/zetsubouk/ai-code-gauge/releases) 下载 `ai-code-gauge-vX.Y.Z.zip`（文件名带版本号，任选最新版），解压后按上述步骤加载。
